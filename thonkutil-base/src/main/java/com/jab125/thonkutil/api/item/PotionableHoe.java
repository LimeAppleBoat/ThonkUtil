...
public class PotionableHoe extends HoeItem implements Potionable {
    public PotionableHoe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
