...
public class TemperatureUtil {
    public static float getTemperature(Entity entity) {
        ...
        System.out.println(entity.world.getBiome(entity.getBlockPos()).getTemperature());
        return entity.world.getBiome(entity.getBlockPos()).getTemperature();
    }
    ...
    private static Biome getEntityBiome(Entity entity) {
        ...
        return entity.world.getBiome(entity.getBlockPos());
    }
}
