...
public class CustomRightElytraEntityModel<T extends LivingEntity> extends AnimalModel<T> {
    private final ModelPart rightWing;
    //private final ModelPart leftWing;

    public CustomRightElytraEntityModel(ModelPart root) {
    ...
    public void setAngles(T livingEntity, float f, float g, float h, float i, float j) {
        ...
        if (livingEntity instanceof AbstractClientPlayerEntity) {
            ...
            this.rightWing.pitch = o.elytraPitch;
            this.rightWing.yaw = -o.elytraYaw;
            this.rightWing.roll = -o.elytraRoll;
        } else {
