...
public class ThonkUtilCapes implements ModInitializer, ThonkUtilCapesClass {
    ...
    public static String createItemModelJson(Identifier id, String type) {
        if ("cape".equals(type)) {
            return "{ \"texture_size\": [64, 32], \"textures\": { \"0\": \""+ id.toString() + "\", \"particle\": \""+ id.toString() + "\" }, \"elements\": [ { \"from\": [3, 0, 0], \"to\": [13, 1, 15], \"faces\": { \"north\": {\"uv\": [0.25, 0.5, 2.75, 1], \"texture\": \"#0\"}, \"east\": {\"uv\": [2.75, 1, 3, 8.5], \"rotation\": 90, \"texture\": \"#0\"}, \"south\": {\"uv\": [2.75, 0, 5.25, 0.5], \"texture\": \"#0\"}, \"west\": {\"uv\": [0, 1, 0.25, 8.5], \"rotation\": 270, \"texture\": \"#0\"}, \"up\": {\"uv\": [0.25, 1, 2.75, 8.5], \"texture\": \"#0\"}, \"down\": {\"uv\": [3, 1, 5.5, 8.5], \"rotation\": 180, \"texture\": \"#0\"} } } ], \"display\": { \"thirdperson_righthand\": { \"translation\": [0, 3, 1], \"scale\": [0.55, 0.55, 0.55] }, \"thirdperson_lefthand\": { \"translation\": [0, 3, 1], \"scale\": [0.55, 0.55, 0.55] }, \"firstperson_righthand\": { \"rotation\": [-75, -173, -12], \"translation\": [0.38, 3.2, -3.5], \"scale\": [0.68, 0.68, 0.68] }, \"firstperson_lefthand\": { \"rotation\": [-75, -173, -12], \"translation\": [0.38, 3.2, -3.5], \"scale\": [0.68, 0.68, 0.68] }, \"ground\": { \"translation\": [0, 2, 0], \"scale\": [0.5, 0.5, 0.5] }, \"gui\": { \"rotation\": [30, -45, 0], \"translation\": [0, 3.5, 0], \"scale\": [0.625, 0.625, 0.625] }, \"head\": { \"rotation\": [-90, 180, 0], \"translation\": [0, -0.5, -14.5], \"scale\": [1.28, 1, 0.85] }, \"fixed\": { \"rotation\": [-90, 180, 0], \"translation\": [0, 0, -8.25] } } }";
        }
        return "";
    }
