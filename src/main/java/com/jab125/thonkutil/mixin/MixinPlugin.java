...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        return !ThonkUtilConfig.POTION_API.getValue() && (mixinClassName.equals("com.jab125.thonkutil.mixin.PotionItemMixin") || mixinClassName.equals("com.jab125.thonkutil.mixin.TippedArrowMixin") || mixinClassName.equals("com.jab125.thonkutil.mixin.PotionRecipeMixin") || mixinClassName.equals("com.jab125.thonkutil.mixin.TippedPotionRecipeMixin")) ? false : true;
    }
