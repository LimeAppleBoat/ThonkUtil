...
public class TradeManager implements IdentifiableResourceReloadListener {
    ...
    public void registerTrader(EntityType<? extends MerchantEntity> type)
    {
    ...
    @Nullable
    public EntityTrades getTrades(EntityType<? extends MerchantEntity> type)
    {
        ...
        return CompletableFuture.allOf(CompletableFuture.runAsync(() ->
        {
            this.traders.forEach(entityType ->
            {
                ...
                resources.sort((r1, r2) -> {
                    ...
                    return r2.getNamespace().equals("thonkutil") ? 1 : -1;
                });
    ...
    public Identifier getFabricId() {
        return new Identifier("thonkutil", "reload_trades");
    }
}
