 ...
 */
@Deprecated
public record StandardTrade(ItemStack offerStack, ItemStack paymentStack, ItemStack secondaryPaymentStack, int maxUses, int experience, float priceMultiplier) implements TradeOffers.Factory
{
    @Nullable
    @Override
