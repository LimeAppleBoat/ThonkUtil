...
public class TestConfigManager {
    ...
    private static void prepareConfigFile() {
        ...
        file = new File(FabricLoader.getInstance().getConfigDir().toFile(), Constants.MODID + ".json");
    }
    ...
    private static void load() {
        ...
        try {
            ...
            System.err.println("Couldn't load Test configuration file; reverting to defaults");
            e.printStackTrace();
        }
    }
    ...
    public static void save() {
        ...
        try (FileWriter fileWriter = new FileWriter(file)) {
            ...
            System.err.println("Couldn't save Test configuration file");
            e.printStackTrace();
        }
    }
}